...
mobl.screenContext = function(elements, callback) {
  ...
  var node2 = $("<div>");
  node2.attr('class', "screenContext");
  node2.attr('style', "position: relative;");
  
  
  var node3 = $("<div>");
  node3.attr('class', "initialElements");
